...
def main_pro():
    ...
    deal_list_file_path = os.path.join(os.path.dirname(__file__), "deal_list.csv")
    deal_output_path = os.path.join(os.path.dirname(__file__), "deal_output.csv")
    json_dump_file = os.path.join(os.path.dirname(__file__), "json_deal_dump.csv")
